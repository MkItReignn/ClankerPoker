...
class Game:
    ...
    def is_hand_complete(self) -> bool:
        from src.domain.rules.round_state_evaluator import RoundStateEvaluator

        return RoundStateEvaluator.is_hand_complete(self)

    def is_round_complete(self) -> bool:
        from src.domain.rules.round_state_evaluator import RoundStateEvaluator

        return RoundStateEvaluator.is_round_complete(self)
    ...
    def is_tournament_complete(self) -> bool:
        ...
        return RoundStateEvaluator.is_tournament_complete(self)
